  ...
  return (
    <div className="group hover:bg-main hover:text-white flex flex-col bg-white h-full font-mont px-8 py-10 text-black rounded-xl transition-all">
      ...
      <div className="flex items-end flex-1 justify-center mt-8">
        <button className="w-[134px]  rounded-[40px] text-sm whitespace-nowrap font-medium px-6 flex items-center justify-center radius bg-main h-10 text-white group-hover:bg-white group-hover:text-main">
          See More
        </button>
      </div>
    </div>
